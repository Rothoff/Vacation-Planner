...
export default function CustomizedTables(props) {
  ...
  if(week !== null) {
    ...
    if (vacDaysEmployee !== null) {
      if(vacDaysEmployee.length!==0){
      return (
        <TableContainer component={Paper}>
          <Table>
            <TableHead >
              <TableRow>
                <StyledTableCell>Vacaction days/month</StyledTableCell>
                <StyledTableCell></StyledTableCell>
                <StyledTableCell></StyledTableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {vacDaysEmployee.map(emp => (
                <StyledTableRow >
                  <StyledTableCell component="th" scope="row">
                    {emp.name}
                  </StyledTableCell>
                  <StyledTableCell align="center"></StyledTableCell>
                  <StyledTableCell align="center">{emp.totalVacDays}</StyledTableCell>
                </StyledTableRow>
              ))}
            </TableBody>
          </Table>
